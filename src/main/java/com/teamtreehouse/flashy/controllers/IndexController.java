...
public class IndexController {
  public static final int NUMBER_OF_CARDS_TO_LIST = 3;
  ...
  public String index(Model model) {
    ...
    List<FlashCard> cards = flashCardService.getRandomFlashCards(NUMBER_OF_CARDS_TO_LIST);
    ...
    if (totalCount >= NUMBER_OF_CARDS_TO_LIST) {
      ctaBuilder.append(" and ");
      ctaBuilder.append(totalCount - NUMBER_OF_CARDS_TO_LIST);
